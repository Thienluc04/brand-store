...
import { ListItem } from "modules/item/ListItem";
      ...
      <div className="max-w-[1180px] mx-auto pt-5 max-lg:px-5">
        ...
        <section className="xl:flex hidden mt-[30px] bg-white border border-gray3 rounded-md">
          <div className="flex flex-col gap-4 p-5 mr-11">
            <div>
              <p className="text-dark font-semibold text-xl leading-7">Deals and offers</p>
        ...
        <section className="xl:mt-[30px] mt-5">
          <h1 className="xl:text-2xl text-lg text-dark font-semibold xl:mb-6 mb-3">
            Recommended items
          </h1>
        ...
        <section className="mt-8 xl:block hidden ">
          ...
          <div className="flex gap-5">
            {listService.map((item, index) => (
              <div key={v4()} className="flex-1 rounded-md border border-[#E0E0E0]">
        ...
        <section className="mt-[30px] mb-10 xl:block hidden">
          ...
          <div className="grid grid-cols-5 gap-[10px]">
            {listRegion.map((item, index) => (
              <div key={v4()} className="flex items-start gap-3">
